...
var userInfo = {
    ...
    jobWant:  "WEB前端开发工程师",
    userQQ:  "695207869",
    userEmail:   "695207869@qq.com",
    motto:  "精通Html/Css/JavaScript；熟悉css3规范；熟悉主流css库，有使用bootstrap框架的经验；能够使用git控制版本工具；熟悉jquery并且能不依赖编写适用的原生Js代码；了解兼容主流各种浏览器的方法；能够编写常见的动态交互效果；能够和设计师良好沟通，实现非常美观的前端页面。", 
    userPhone: 18993863964,
    userOrignPlace:  "甘肃省天水市" ,
    userSeatPlace:  "北京市",
    userWeibo: "https://github.com/HMiaos",
    userAssessment: "天津铁道职业技术学院（大专）",   
    userHobby: ["历史","游戏","电影"]
}
